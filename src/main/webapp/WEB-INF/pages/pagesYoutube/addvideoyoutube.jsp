        ...
        <div class="rightcolumn">
            <div class="card">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="/add-videoyoutube.htm" method="POST" role="form">
                        <legend>Add New Employee</legend>

                        <div class="form-group">
                            <input type="text" required class="form-control" id="VideoID" name="VideoID" placeholder="VideoID">
                        </div>
                        <div class="form-group">
                            <input type="number" required class="form-control" id="CoinValue" name="CoinValue" placeholder="CoinValue">
                        </div>
                        <div class="form-group">
                            <input type="number" required class="form-control" id="DailyClick" name="DailyClick" placeholder="DailyClick">
                        </div>
                        <div class="form-group">
                            <input type="number" required class="form-control" id="TotalClick" name="TotalClick" placeholder="TotalClick">
                        </div>
                        <div class="form-group">
                            <input type="number" required class="form-control" id="Active" name="Active" placeholder="Active">
                        </div>
                        <button type="submit" class="btn btn-primary">add-videoyoutube</button>
                    </form>
                </div>
